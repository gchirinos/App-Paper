...
public class SalvarListaDeNoticiaFragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AppPaper.Fragments.SalvarListaDeNoticiaFragment, AppPaper", SalvarListaDeNoticiaFragment.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SalvarListaDeNoticiaFragment.class)
			mono.android.TypeManager.Activate ("AppPaper.Fragments.SalvarListaDeNoticiaFragment, AppPaper", "", this, new java.lang.Object[] {  });
	}
